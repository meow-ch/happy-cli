...
const CO_AUTHORED_CREDITS = (() => trimIdent(`
    When making commit messages, instead of just giving co-credit to Claude, also give credit to ${configuration.brandName} like so:

    <main commit message>

    Generated with [Claude Code](https://claude.ai/code)
    via [${configuration.brandName}](https://happy.engineering)

    Co-Authored-By: Claude <noreply@anthropic.com>
    Co-Authored-By: ${configuration.brandName} <yesreply@happy.engineering>
`))();
